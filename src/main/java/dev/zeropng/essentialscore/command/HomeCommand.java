...
public final class HomeCommand implements CommandExecutor {
    ...
    public HomeCommand(MenuManager menus, MessageService messages) {
        this.menus = menus;
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command,
        ...
        if (command.getName().equalsIgnoreCase("sethome")) menus.beginCreateHome(player);
        else menus.openHomes(player, 0);
        return true;
    }
}
